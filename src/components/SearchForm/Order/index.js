...
const SearchFormOrder = ({ listAllCustomer, listAllOrderStatus, onClear, onSubmit, flagResetForm }) => {
    ...
    <Box component="form" sx={{ bgcolor: '#FFFFFF', p: 2, mt: 2, borderRadius: '10px', position: 'relative' }}>
      ...
      <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 2 }}>
        ...
        <Autocomplete
          ...
          renderInput={(params) => <TextField {...params} label={t('customer')} variant="outlined" />}
        />
        <Autocomplete
          popupIcon={<PolygonIcon />}
          size="small"
...
export default SearchFormOrder
