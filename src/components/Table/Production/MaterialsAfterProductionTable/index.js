...
export default function MaterialsAfterProductionTable ({ titleTable, data }) {
                    ...
                    {data.length === 0 ? (
                        ...
                        data.map((item, index) => (
                            ...
                            >
                                ...
                                <StyledTableCell sx={{textAlign:'center !important'}}>{item.estimatedFormationTime}</StyledTableCell>
                            </StyledTableRow>
                        ))
                    )}
                </TableBody>
