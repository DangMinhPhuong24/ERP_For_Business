...
export default class CreateOderRequest extends Request {
  static Keys = {
    ODER_CUSTOMER_ID: paramKeys.ODER_CUSTOMER_ID,
    ODER_ADDRESS_BRANCH_ID: paramKeys.ODER_ADDRESS_BRANCH_ID,
    ORDER_ADDRESS_DELIVERY_ID: paramKeys.ORDER_ADDRESS_DELIVERY_ID,
    ...
    DELIVERY_TIME: paramKeys.DELIVERY_TIME,
    INTERNAL_DESCRIPTION: paramKeys.INTERNAL_DESCRIPTION,
    TAX_PERCENT: paramKeys.TAX_PERCENT,
    MANUFACTURE_ORDER_PRODUCT_WAREHOUSE: paramKeys.MANUFACTURE_ORDER_PRODUCT_WAREHOUSE
  }
}
